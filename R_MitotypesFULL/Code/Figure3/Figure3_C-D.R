...
p <-data_pathways %>%
  ...
  theme(axis.title = element_blank(),
        axis.text = element_text(size = 4))
print(p)
ggsave(here::here("Figures", "Figure3", "Fig3C_Bivariate2.png"), width = 1.17, height = 1.15, units = "in", dpi = 1200)
plotly::ggplotly(p)
...
p <-data_pathways %>%
  ...
  theme(axis.title = element_blank(),
        axis.text = element_text(size = 4))
print(p)
ggsave(here::here("Figures", "Figure3", "Fig3C_Bivariate3.png"), width = 1.2, height = 1.15, units = "in", dpi = 1200)
plotly::ggplotly(p)
