...
png(here::here("Figures", "Figure3", "Fig3C_CorrHeatmap_hm.png"), width = 4, height = 3.6, units = "in", res = 1200)
draw(hm)

dev.off()


## Figure 3C Example bivariates ------------------------------------------------------
...
ggsave(here::here("Figures", "Figure3", "Fig3C_Bivariate1.png"), width = 1.2, height = 1.15, units = "in", dpi = 1200)
plotly::ggplotly(p)
...
p <-data_pathways %>%
  ...
  theme(axis.title = element_blank(),
        axis.text = element_text(size = 4))
p
ggsave(here::here("Figures", "Figure3", "Fig3C_Bivariate2.png"), width = 1.2, height = 1.15, units = "in", dpi = 1200)
plotly::ggplotly(p)
...
p <-data_pathways %>%
  ...
  theme(axis.title = element_blank(),
        axis.text = element_text(size = 4))
p
ggsave(here::here("Figures", "Figure3", "Fig3C_Bivariate3.png"), width = 1.17, height = 1.15, units = "in", dpi = 1200)
plotly::ggplotly(p)
cor.test(data_pathways$`mt-tRNA modifications`, data_pathways$`Complex I`, "two.sided","spearman")



# Figure 3D network graph -------------------------------------------------
...
png(here::here("Figures", "Figure3", "Fig3D_Network_graph.png"), width = 6.6, height = 6.6, units = "in", res = 1200)
...
p <- data_tissue_cor %>%
  ...
  theme(axis.text = element_text(size = 6),
        axis.title = element_text(size = 7))
p
ggsave(here::here("Figures", "Figure3", "Fig3D_Bivariate.png"), width = 1.2, height = 1, units = "in" , dpi = 1200)
plotly::ggplotly(p)
