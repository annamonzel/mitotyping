...
autoplot(pca, data = combined %>%
  ...
  theme_pca + 
  scale_y_reverse() 
ggsave(here::here("Figures", "Figure6", "Suppl_FigS8D_PCA_Tissue_Fibroblasts_AllTreatments_AllPassagesAveraged_subset.png"), 
       height = 1.35, width = 1.5,unit = "in", dpi = 1200)
...
ggplot() +
  ...
  theme(axis.text.y= element_text(size =6),
        axis.ticks.y = element_blank(),
        axis.title = element_text(size = 7))
ggsave(here::here("Figures", "Figure6", "Suppl_FigS10A_dynamic_range_large.png"), 
